...
wsl -d Ubuntu -- bash -lc ^
  "source /home/frank/miniconda3/etc/profile.d/conda.sh && conda activate mamba_env && cd /mnt/d/Desktop/work/ProjectForMe/MarketMamba && python V6/run_daily_inference.py 2>&1 | tee -a V6/logs/inference.log; exit ${PIPESTATUS[0]}"
