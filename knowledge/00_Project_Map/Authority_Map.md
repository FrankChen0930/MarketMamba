...
> Human review accepted: `2026-09-20`; canonical means current accepted navigation authority, not immutable final state.
...
| Local untracked candidates | None | `UNKNOWN` | `NOT_ADMITTED` | File-existence/current-version inference | Main untracked V7 API/UI and research files | No branch commit/contract or deployment authority from untracked source. |
...
| Production runtime | [`V6/run_v62_daily.py`](../../V6/run_v62_daily.py) plus observed scheduler action | `CURRENT_REFERENCE` | `FETCH_ONLY_ACTIVE`; full path `DISABLED` | README/OVERVIEW implication of full scheduled daily inference | [`V6/scripts/v62_daily.bat`](../../V6/scripts/v62_daily.bat) | Code shows capability; scheduler observation shows active selection. |
| Scheduler state | `MarketMamba_DataFetch` / `MarketMamba_V62` observation at `2026-09-20T01:30:00+08:00` | `RUNTIME_OBSERVATION` | Active fetch-only / disabled full V6.2; expires after 7 days | Older scheduler snapshots | [K0 runtime map](../../research/project-knowledge/k0/runtime-map.json) | Becomes `STALE_OBSERVATION` after 2026-09-27 until rechecked. |
...
| API/UI | None for live deployment state | `UNKNOWN` | `UNKNOWN` | Claims inferred from source presence | [`app/backend/main.py`](../../app/backend/main.py), [`app/frontend/src/App.jsx`](../../app/frontend/src/App.jsx), local untracked V7 candidates | Source capability does not prove deployment; V7 candidates are unmerged. |
